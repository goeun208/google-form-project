  ...
  return (
    <>
      <article className="w-full h-full mx-auto">
        <section>
          <div className="w-full h-[135px] text-white flex flex-col items-center justify-center bg-[url(/images/sub/bg_subbanner01.jpg)] bg-no-repeat bg-center bg-cover">
            <h2 className="text-4xl font-medium pb-2">이용안내</h2>
            <p className="text-base">홈 &gt; 일반대여 &gt; 차량리스트</p>
          </div>
        </section>
        <section>
            ...
            <div className="max-w-[1080px] h-full box-border mx-auto">
              ...
              <div className="w-full h-full">
                <ul className="flex items-center justify-center flex-wrap">
                  <Link href="/rental/general/foreign?tab=benz">
                    <a>
                  ...
                  <Link href="/rental/general/foreign?tab=audi">
                    <a>
                  ...
                  <Link href="/rental/general/foreign?tab=bmw">
                    <a>
                  ...
                  <Link href="/rental/general/foreign?tab=rand">
                    <a>
                  ...
                  <Link href="/rental/general/foreign?tab=porsche">
                    <a>
                  ...
                  <Link href="/rental/general/foreign?tab=etc">
                    <a>
        ...
        <section>
          <div className="w-full h-full lg:pt-[95px] lg:pb-[150px] pt-[50px] pb-[100px] bg-[url(/images/sub/bg_subkorea.jpg)] bg-no-repeat bg-center bg-cover">
            <div className="max-w-[1080px] h-full box-border mx-auto">
              ...
              <div className="w-full h-full">
                <ul className="flex items-center justify-center flex-wrap">
                  <Link href="/rental/general/domestic?tab=hyundai">
                    <a>
                  ...
                  <Link href="/rental/general/domestic?tab=kia">
                    <a>
                  ...
                  <Link href="/rental/general/domestic?tab=chevolet">
                    <a>
                  ...
                  <Link href="/rental/general/domestic?tab=samsung">
                    <a>
                  ...
                  <Link href="/rental/general/domestic?tab=ssangyong">
                    <a>
